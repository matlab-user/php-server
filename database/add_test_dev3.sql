/*		添加公司第三台设备		*/
SET @g1 = '54455354444556535357415900000003';
SET @g2 = '00000003535741594445565354455354';
SET @intv = 30;
SET @name = '农业环境测量仪';
...
/* 
	...
	数据累积型
*/
INSERT INTO data_db.dev_data_unit ( d_id, dev_id, d_t, utid, v_name, remark) SELECT 1, @g1, 1, id, '姿态', '设备姿态' FROM data_db.unit_table WHERE unit='<sup>。</sup>';
INSERT INTO data_db.dev_data_unit ( d_id, dev_id, d_t, utid, v_name, remark) SELECT 2, @g1, 1, id, 'CO2浓度', '大气二氧化碳浓度' FROM data_db.unit_table WHERE unit='ppm';
