...
INSERT INTO dev_db.dev_table SET guid1=@g1, guid2=@g2, intv=@intv, name=@name, k='wangdehui', owner='demo', model='wdh-1', state='running', maker='成都实唯科技', longitude=104.06, latitude=30.67;
